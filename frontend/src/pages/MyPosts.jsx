        ...
        // );
          ...
          return (
                      <motion.div
                        ...
                        className="w-full max-w-3xl bg-white/10 backdrop-blur-lg border border-gray-600 rounded-2xl p-5 shadow-lg hover:scale-105 transition-all flex flex-col justify-center"
