...
declare const DEFAULT_CHROMA_EMBED_URL = "https://embed.trychroma.com";
declare function getChromaEmbedUrl(): string;
/**
...
export { DEFAULT_CHROMA_EMBED_URL, decodeBase64Embedding, getAvailableSchemas, getChromaEmbedUrl, getSchemaInfo, getSchemaVersion, isBrowser, loadSchema, snakeCase, validateConfigSchema };
